...
SECRET_KEY = "django-insecure-o0qd7xfcb6d-0bvhv*k33dr3_jv29y9$sqfd)rnrpwr%3*$p!="
...
JAZZMIN_SETTINGS = {
    ...
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": ["users", "projects", "tasks"],
